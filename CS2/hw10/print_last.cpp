...
class LinkedList {
    ...
    public:
        ...
        void printLast () {
            ...
            cout << current_node_pt->getData() << endl;
        }

        void util_printLastRecursive (Node* current_node) {
            if (current_node->getNext() == nullptr) {
                cout << current_node->getData() << endl;
            } else {
                util_printLastRecursive(current_node->getNext());
            }
        }

        void printLastRecursive () {
            Node* current_node_pt = pt_head;
            util_printLastRecursive(current_node_pt);
        }
...
int main () {
    LinkedList listy;
    listy.addNodetoBack("0");
    listy.addNodetoBack("1");
    listy.addNodetoBack("2");
    listy.addNodetoBack("3");
    listy.addNodetoBack("4");
    listy.addNodetoBack("5");
    listy.printLast();
    listy.printLastRecursive();
